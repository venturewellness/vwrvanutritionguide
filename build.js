...
if (!apiKey) {
  console.error('ERROR: FIREBASE_API_KEY environment variable is not set in Netlify.');
  console.error('Add it under Site configuration → Environment variables, then redeploy.');
  process.exit(1);
}
